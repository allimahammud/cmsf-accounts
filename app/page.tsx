...
=======
    <main className="min-h-screen overflow-hidden bg-white">
      ...
      <section className="relative h-[200px] overflow-hidden bg-gradient-to-r from-blue-700 via-blue-600 to-indigo-700">
        {/* Background decoration */}
...
>>>>>>> 98ed8f2 (update 14-sep-26 purpose landing page changed)
        ...
        {/* Top title */}
        <div className="relative mx-auto -mt-12 max-w-7xl px-6  text-center lg:px-8">
          ...
          <h1
            className={`${lusitana.className} mt-1 text-4xl font-bold text-white sm:text-5xl`}
          >
            Manage Your Business
